					...
					<div class="theme-uikit theme-<?=$arParams['THEME'];?> color-<?=$arParams['COLOR'];?>">
						<form id="<?=$FORM_ID?>"
							...
							<? if($arParams['USE_PRIVACY'] && $arParams['MESS_PRIVACY']): ?>
								<div class="uk-form-row api-rules">
									<div class="uk-form-controls">
                                        <input type="checkbox" name="PRIVACY_ACCEPTED" checked value="Y" class="api-field" <?=$arResult['PRIVACY_ACCEPTED'] == 'Y' ? ' checked' : ''?>>
										<label class="api-rules-label">
											<div class="api-rules-title">
												<? if($arParams['MESS_PRIVACY_LINK']): ?>
													Я согласен на обработку персональных данных<br>
                                                    <a rel="nofollow" href="<?=$arParams['MESS_PRIVACY_LINK']?>" target="_blank">Политика защиты персональных данных</a>
												<? else: ?>
