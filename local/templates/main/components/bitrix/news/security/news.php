...
$rsSections = CIBlockSection::GetList(
    array(),
    array('IBLOCK_ID' => $arParams['IBLOCK_ID'], 'CODE' => 'fire_safety')
);
$arSection = $rsSections->Fetch();?>
<?//=Sepro\Helpers::printPre($arSection)?>
<?$APPLICATION->SetTitle($arSection['NAME']);
?>
<div id="block117" class="block-wrapper">
    <section class="landing-block g-bg-pattern-gray-v1 js-animation fadeInUp top_padd_rem g-pb-20" style="animation-duration: 1000ms; animation-play-state: running; animation-name: none;">
        <div class="container">
